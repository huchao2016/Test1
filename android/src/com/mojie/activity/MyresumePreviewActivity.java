...
public class MyresumePreviewActivity extends Activity implements OnClickListener,
...
//		uid = shared.getInt("id", 0);
		...
		pd = new ProgressDialog(MyresumePreviewActivity.this);
		...
		tvMyresumeChoose.setVisibility(View.GONE);
...
//		radioGroupMyresumePreviewMemberType.setOnCheckedChangeListener(this);
		...
		myresumePreviewGoodListAdapter = new MyresumePreviewGoodListAdapter(MyresumePreviewActivity.this, pArray);
		...
		evaluationTaskListAdapter = new EvaluationTaskListAdapter(MyresumePreviewActivity.this, eArray);
		...
		evaluationTenderListAdapter = new EvaluationTenderListAdapter(MyresumePreviewActivity.this, tenderArray);
...
//		headpic = shared.getString("headpic", "");
	...
	private void putImg(){
		 ...
		 if(bitmap != null){
			 ...
			 bitmap = ConstUtils.mCache.getBitmapFromDiskCache(MyresumePreviewActivity.this, headpic, -1);
				 ...
				 PHPLOADIMGUtils.onLoadImage(ConstUtils.IMGURL+headpic, new OnLoadImageListener() {
						...
						public void OnLoadImage(Bitmap bitmap, String bitmapPath) {
							...
							if (bitmap != null) {
								...
								if (bitmap != null) {
									ConstUtils.mCache.addBitmapToDiskCache(MyresumePreviewActivity.this, headpic, bitmap);
								}
							}
						}
					});
	...
	private Handler pHandler = new Handler(){  
		...
		public void handleMessage(android.os.Message msg) {
			...
			if (msg.obj == null){//获取数据失败
				Toast.makeText(MyresumePreviewActivity.this, "网络连接失败",Toast.LENGTH_LONG).show();
			}else{
				try {
...
//							radioMyresumePreviewEnterprise.setChecked(true);
						...
						if( total_num != 0 ){
							...
							for(int i =  0 ; i < mJSONArray.length(); i++)
			                {
								 ...
								 Log.v("lishide", "preview>>tid == "+tid);
								 Log.v("lishide", "preview>>tagname_cn == "+tagname_cn);
						...
						Toast.makeText(MyresumePreviewActivity.this,"失败",Toast.LENGTH_SHORT).show();
					}
	...
	public void onClick(View v) {
		...
		case R.id.layout_myresume_preview_project_experience:
			intent = new Intent(MyresumePreviewActivity.this,ProjectExperienceListActivity.class);
