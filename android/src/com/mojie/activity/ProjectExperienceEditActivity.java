...
public class ProjectExperienceEditActivity extends Activity implements OnClickListener{
...
//			enddate = editProjectFinishTime.getText().toString();
			...
			if("".equals(title)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入标题",Toast.LENGTH_SHORT).show();
				break;
			}else if("".equals(begindate)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入项目开始时间",Toast.LENGTH_SHORT).show();
				break;
			}else if("".equals(enddate)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入项目完成时间",Toast.LENGTH_SHORT).show();
				break;
			}else if("".equals(description)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入项目简介",Toast.LENGTH_SHORT).show();
				break;
			}else if("".equals(provedby)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入证明人姓名",Toast.LENGTH_SHORT).show();
				break;
			}else if("".equals(provertel)) {
				Toast.makeText(ProjectExperienceEditActivity.this,"请输入证明人电话",Toast.LENGTH_SHORT).show();
				break;
			}
			
			pd = new ProgressDialog(ProjectExperienceEditActivity.this);
			pd.setMessage("请稍后…");
			pd.show();
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			if (msg.obj == null) {// 获取数据失败
				Toast.makeText(ProjectExperienceEditActivity.this, "网络连接失败",
					...
					try {
						...
						if (result == 0) {
							...
							Toast.makeText(ProjectExperienceEditActivity.this, "更新项目经验失败",
									Toast.LENGTH_SHORT).show();
						}
