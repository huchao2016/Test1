...
public class MyresumePreviewGoodListAdapter extends BaseAdapter{
	...
	private int type;
    public MyresumePreviewGoodListAdapter(Context context,ArrayList<HashMap<String, String>>mArray){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            holder.myresumeAddGoodItem = (LinearLayout)convertView.findViewById(R.id.good_item);
