...
import com.mojie.utils.AsyncBitmapLoader;
import com.mojie.utils.ConstUtils;
import com.nostra13.universalimageloader.core.ImageLoader;

public class TaskTaskClassAdapter extends BaseAdapter{
    private Context context;
    public ArrayList<HashMap<String, String>>mArray;
	private String headpic;
	private ImageLoader imageLoader;
    public TaskTaskClassAdapter(Context context,ArrayList<HashMap<String, String>>mArray){
